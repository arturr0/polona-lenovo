...
async function main() {
  try {
    ...
    const googleResults = await searchOnGoogle("Skrót historji nowożytnej przystosowany do programu Ministerstwa W.R. i O.P");

      for (const result of googleResults) {
        await fetchPageContent(result.link, "Skrót historji nowożytnej przystosowany do programu Ministerstwa W.R. i O.P");
      }
