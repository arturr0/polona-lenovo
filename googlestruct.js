...
(async () => {
    ...
    await page.goto(`https://www.google.com/search?q=${encodeURIComponent("Fr. Kr. Szlossera Dzieje powszechne. T. 1, [Dzieje starożytne. 1, Ludy wschodnie. 2, Ludy okresu grecko-rzymskiego]" + " audiobook")}+site:gov.pl` , { waitUntil: 'domcontentloaded' });
